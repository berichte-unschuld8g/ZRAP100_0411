CLASS zcl_rap100_gen_data_411 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_411 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '411',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   CLEAR DATA
    DELETE FROM zrap100_atrav411.
    DELETE FROM zrap100_atrav411.

    "insert travel demo data
    INSERT zrap100_atrav411 FROM (
    SELECT
